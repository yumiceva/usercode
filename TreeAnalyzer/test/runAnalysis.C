...
void runAnalysis(TString sample="all",bool NoGUI=false, bool getLogs=false) 
{
  ...
  if (sample=="MCcomphep"||sample=="WpRH800"||sample=="all")
    {
      ...
      mc_wp_rh_800->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-800_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH900"||sample=="all")
    {
      ...
      mc_wp_rh_900->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-900_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH1000"||sample=="all")
    {
      ...
      mc_wp_rh_1000->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1000_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH1100"||sample=="all")
    {
      ...
      mc_wp_rh_1100->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1100_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH1200"||sample=="all")
    {
      ...
      mc_wp_rh_1200->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1200_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH1300"||sample=="all")
    {
      ...
      mc_wp_rh_1300->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1300_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH1400"||sample=="all")
    {
      ...
      mc_wp_rh_1400->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1400_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH1500"||sample=="all")
    {
      ...
      mc_wp_rh_1500->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1500_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH1600"||sample=="all")
    {
      ...
      mc_wp_rh_1600->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1600_RightWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH800"||sample=="all")
    {
      ...
      mc_wp_lh_800->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-800_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH900"||sample=="all")
    {
      ...
      mc_wp_lh_900->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-900_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1000"||sample=="all")
    {
      ...
      mc_wp_lh_1000->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1000_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1100"||sample=="all")
    {
      ...
      mc_wp_lh_1100->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1100_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1200"||sample=="all")
    {
      ...
      mc_wp_lh_1200->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1200_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1300"||sample=="all")
    {
      ...
      mc_wp_lh_1300->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1300_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1400"||sample=="all")
    {
      ...
      mc_wp_lh_1400->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1400_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1500"||sample=="all")
    {
      ...
      mc_wp_lh_1500->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1500_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1600"||sample=="all")
    {
      ...
      mc_wp_lh_1600->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1600_LeftWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix800"||sample=="all")
    {
      ...
      mc_wp_mix_800->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-800_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix900"||sample=="all")
    {
      ...
      mc_wp_mix_900->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-900_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1000"||sample=="all")
    {
      ...
      mc_wp_mix_1000->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1000_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1100"||sample=="all")
    {
      ...
      mc_wp_mix_1100->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1100_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1200"||sample=="all")
    {
      ...
      mc_wp_mix_1200->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1200_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1300"||sample=="all")
    {
      ...
      mc_wp_mix_1300->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1300_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1400"||sample=="all")
    {
      ...
      mc_wp_mix_1400->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1400_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1500"||sample=="all")
    {
      ...
      mc_wp_mix_1500->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1500_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1600"||sample=="all")
    {
      ...
      mc_wp_mix_1600->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WprimeToTB_M-1600_MixRLWprime_TuneZ2_7TeV_comphep_Mu.root");
  ...
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  */
  if (sample=="Wprime2000"||sample=="all")
    {
      TDSet *mc_wp_2000 = new TDSet("top","*","/PATNtupleMaker");
      mc_wp_2000->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/Wprime2000_Mu.root");
  ...
  if (sample=="MC"||sample=="ttbar"||sample=="all")
    {
      ...
      mc_ttbar->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/TTbar_Mu.root");
  ...
  if (sample=="MC"||sample=="WJets"||sample=="all")
    {
      ...
      mc_Wjets->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WJets_Mu.root");
  ...
  if (sample=="MC"||sample=="QCD"||sample=="all")
    {
      ...
      mc_QCD->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/QCD_Mu.root");
  ...
  if (sample=="MC"||sample=="STsch"||sample=="all")
    {
      ...
      mc_STsch->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/STsch_Mu.root");
  ...
  if (sample=="MC"||sample=="STtch"||sample=="all")
    {
      ...
      mc_STtch->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/STtch_Mu.root");
  ...
  if (sample=="MC"||sample=="STtWch"||sample=="all")
    {
      ...
      mc_STtWch->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/STtWch_Mu.root");
  ...
  if (sample=="MC"||sample=="STsch_bar"||sample=="all")
    {
      ...
      mc_STsch_bar->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/STsch_bar_Mu.root");
  ...
  if (sample=="MC"||sample=="STtch_bar"||sample=="all")
    {
      ...
      mc_STtch_bar->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/STtch_bar_Mu.root");
  ...
  if (sample=="MC"||sample=="STtWch_bar"||sample=="all")
    {
      ...
      mc_STtWch_bar->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/STtWch_bar_Mu.root");
  ...
  if (sample=="MC"||sample=="WW"||sample=="all")
    {
      ...
      mc_WW->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WW_Mu.root");
  ...
  if (sample=="MC"||sample=="WZ"||sample=="all")
    {
      ...
      mc_WZ->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WZ_Mu.root");
  ...
  if (sample=="MC"||sample=="ZJets"||sample=="all")
    {
      ...
      mc_ZJets->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/ZJets_Mu.root");
  ...
  if (sample=="MCsyst"||sample=="WJetsScaleUp"||sample=="all")
    {
      ...
      mc_WJets_scaleup->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WJets_scaledup_Mu.root");
  ...
  if (sample=="MCsyst"||sample=="WJetsScaleDown"||sample=="all")
    {
      ...
      mc_WJets_scaledown->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_1/WJets_scaledown_Mu.root");
  ...
  if (sample=="data"||sample=="all")
    {
      ...
      data->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/Data/2011Muon/42x_v9/SingleMu_May10ReReco_Mu.root");
      data->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/Data/2011Muon/42x_v9/SingleMu_PromptReco-v4_Run_165088_166967_Mu.root");
      data->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/Data/2011Muon/42x_v9/SingleMu_PromptReco-v4_Run_167039_167913_Mu.root");
      data->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/Data/2011Muon/42x_v9/SingleMu_Aug05ReReco_Mu.root");
      data->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/Data/2011Muon/42x_v9/SingleMu_PromptReco-v6_Run_172620_173198_Mu.root");
      data->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/Data/2011Muon/42x_v9/SingleMu_PromptReco-v6_Run_173236_173692_Mu.root");
      data->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/Data/2011Muon/42x_v9/SingleMu_Run2011B-PromptReco-v1_Mu.root");
