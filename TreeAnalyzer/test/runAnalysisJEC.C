...
void runAnalysisJEC(TString sample="all") 
{
  ...
  if (sample=="MCcomphep"||sample=="WpRH800"||sample=="all")
    {
      ...
      mc_wp_rh_800->Process("Analyzer.C+","JECUP sample=WpRH800");
    
      mc_wp_rh_800->Process("Analyzer.C+","JECDOWN sample=WpRH800");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH900"||sample=="all")
    {
      ...
      mc_wp_rh_900->Process("Analyzer.C+","JECUP sample=WpRH900");
    
      mc_wp_rh_900->Process("Analyzer.C+","JECDOWN sample=WpRH900");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH1000"||sample=="all")
    {
      ...
      mc_wp_rh_1000->Process("Analyzer.C+","JECUP sample=WpRH1000");
    
      mc_wp_rh_1000->Process("Analyzer.C+","JECDOWN sample=WpRH1000");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH1100"||sample=="all")
    {
      ...
      mc_wp_rh_1100->Process("Analyzer.C+","JECUP sample=WpRH1100");
    
      mc_wp_rh_1100->Process("Analyzer.C+","JECDOWN sample=WpRH1100");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH1200"||sample=="all")
    {
      ...
      mc_wp_rh_1200->Process("Analyzer.C+","JECUP sample=WpRH1200");
    
      mc_wp_rh_1200->Process("Analyzer.C+","JECDOWN sample=WpRH1200");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH1300"||sample=="all")
    {
      ...
      mc_wp_rh_1300->Process("Analyzer.C+","JECUP sample=WpRH1300");
    
      mc_wp_rh_1300->Process("Analyzer.C+","JECDOWN sample=WpRH1300");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH1400"||sample=="all")
    {
      ...
      mc_wp_rh_1400->Process("Analyzer.C+","JECUP sample=WpRH1400");
    
      mc_wp_rh_1400->Process("Analyzer.C+","JECDOWN sample=WpRH1400");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH1500"||sample=="all")
    {
      ...
      mc_wp_rh_1500->Process("Analyzer.C+","JECUP sample=WpRH1500");
    
      mc_wp_rh_1500->Process("Analyzer.C+","JECDOWN sample=WpRH1500");
    }
  ...
  if (sample=="MCcomphep"||sample=="WpRH1600"||sample=="all")
    {
      ...
      mc_wp_rh_1600->Process("Analyzer.C+","JECUP sample=WpRH1600");
  ...
  if (sample=="MC"||sample=="Wprime800"||sample=="all")
    {
      ...
      mc_wp_800->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_3/Wprime800_Mu.root");
  ...
  if (sample=="MC"||sample=="Wprime1000"||sample=="all")
    {
      ...
      mc_wp_1000->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_3/Wprime1000_Mu.root");
  ...
  if (sample=="MC"||sample=="Wprime1200"||sample=="all")
    {
      ...
      mc_wp_1200->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_3//Wprime1200_Mu.root");
  ...
  if (sample=="MC"||sample=="Wprime1500"||sample=="all")
    {
      ...
      mc_wp_1500->Add("/uscms_data/d3/ttmuj/Documents/NtupleMaker/MC/v9_3/Wprime1500_Mu.root");
  ...
  if (sample=="MCcomphep"||sample=="WpRH2000"||sample=="all")
    {
      ...
      mc_wp_2000->Process("Analyzer.C+","JECUP sample=WpRH2000");
    
      mc_wp_2000->Process("Analyzer.C+","JECDOWN sample=WpRH2000");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH800"||sample=="all")
    {
      ...
      mc_wp_lh_800->Process("Analyzer.C+","JECUP sample=WpLH800");

      mc_wp_lh_800->Process("Analyzer.C+","JECDOWN sample=WpLH800");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1000"||sample=="all")
    {
      ...
      mc_wp_lh_1000->Process("Analyzer.C+","JECUP sample=WpLH1000");

      mc_wp_lh_1000->Process("Analyzer.C+","JECDOWN sample=WpLH1000");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1100"||sample=="all")
    {
      ...
      mc_wp_lh_1100->Process("Analyzer.C+","JECUP sample=WpLH1100");

      mc_wp_lh_1100->Process("Analyzer.C+","JECDOWN sample=WpLH1100");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1200"||sample=="all")
    {
      ...
      mc_wp_lh_1200->Process("Analyzer.C+","JECUP sample=WpLH1200");

      mc_wp_lh_1200->Process("Analyzer.C+","JECDOWN sample=WpLH1200");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1300"||sample=="all")
    {
      ...
      mc_wp_lh_1300->Process("Analyzer.C+","JECUP sample=WpLH1300");

      mc_wp_lh_1300->Process("Analyzer.C+","JECDOWN sample=WpLH1300");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1400"||sample=="all")
    {
      ...
      mc_wp_lh_1400->Process("Analyzer.C+","JECUP sample=WpLH1400");

      mc_wp_lh_1400->Process("Analyzer.C+","JECDOWN sample=WpLH1400");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1500"||sample=="all")
    {
      ...
      mc_wp_lh_1500->Process("Analyzer.C+","JECUP sample=WpLH1500");

      mc_wp_lh_1500->Process("Analyzer.C+","JECDOWN sample=WpLH1500");
    }
  ...
  if (sample=="MCcomphepL"||sample=="WpLH1600"||sample=="all")
    {
      ...
      mc_wp_lh_1600->Process("Analyzer.C+","JECUP sample=WpLH1600");

      mc_wp_lh_1600->Process("Analyzer.C+","JECDOWN sample=WpLH1600");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix800"||sample=="all")
    {
      ...
      mc_wp_mix_800->Process("Analyzer.C+","JECUP sample=WpMix800");
    
      mc_wp_mix_800->Process("Analyzer.C+","JECDOWN sample=WpMix800");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix900"||sample=="all")
    {
      ...
      mc_wp_mix_900->Process("Analyzer.C+","JECUP sample=WpMix900");
    
      mc_wp_mix_900->Process("Analyzer.C+","JECDOWN sample=WpMix900");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1000"||sample=="all")
    {
      ...
      mc_wp_mix_1000->Process("Analyzer.C+","JECUP sample=WpMix1000");
    
      mc_wp_mix_1000->Process("Analyzer.C+","JECDOWN sample=WpMix1000");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1100"||sample=="all")
    {
      ...
      mc_wp_mix_1100->Process("Analyzer.C+","JECUP sample=WpMix1100");
    
      mc_wp_mix_1100->Process("Analyzer.C+","JECDOWN sample=WpMix1100");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1200"||sample=="all")
    {
      ...
      mc_wp_mix_1200->Process("Analyzer.C+","JECUP sample=WpMix1200");
    
      mc_wp_mix_1200->Process("Analyzer.C+","JECDOWN sample=WpMix1200");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1300"||sample=="all")
    {
      ...
      mc_wp_mix_1300->Process("Analyzer.C+","JECUP sample=WpMix1300");
    
      mc_wp_mix_1300->Process("Analyzer.C+","JECDOWN sample=WpMix1300");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1400"||sample=="all")
    {
      ...
      mc_wp_mix_1400->Process("Analyzer.C+","JECUP sample=WpMix1400");
    
      mc_wp_mix_1400->Process("Analyzer.C+","JECDOWN sample=WpMix1400");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1500"||sample=="all")
    {
      ...
      mc_wp_mix_1500->Process("Analyzer.C+","JECUP sample=WpMix1500");
    
      mc_wp_mix_1500->Process("Analyzer.C+","JECDOWN sample=WpMix1500");
    }
  ...
  if (sample=="MCcomphepMix"||sample=="WpMix1600"||sample=="all")
    {
      ...
      mc_wp_mix_1600->Process("Analyzer.C+","JECUP sample=WpMix1600");
    
      mc_wp_mix_1600->Process("Analyzer.C+","JECDOWN sample=WpMix1600");
    }
