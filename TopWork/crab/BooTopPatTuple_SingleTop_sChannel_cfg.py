...
process.source = cms.Source("PoolSource",
    ...
    #
	'/store/mc/Summer08/SingleTop_sChannel/GEN-SIM-RECO/IDEAL_V9_v1/0000/141CBEA2-A8CD-DD11-9711-001A645CE7F4.root'
    )
...
##  fileName = cms.untracked.string('/afs/cern.ch/user/r/rwolf/pccmsuhh06/testPatTuple_recHits_221.root')
    fileName = cms.untracked.string('SingleTop_sChannel.root'),
