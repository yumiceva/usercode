...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/Yumiceva/TopWork/crab/CMSSW_3_1_X/BooTopPatTuple_InclusiveMu15_Summer09_cfg.py,v $')
)
