...
extended to consider correlations for the Soft Lepton tagger. In this 
case the Soft Lepton tagger is a simple tagger based only in the 
...
solutions are available. As a result, the convergence range 
in jet $p_T$ of this
