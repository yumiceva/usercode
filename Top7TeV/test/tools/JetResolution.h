...
namespace res{
 ...
 double res::HelperJet::pt(double pt, double eta,  Flavor flav)
{
 ...
 double res::HelperJet::a(double pt, double eta,  Flavor flav)
{
  double res = 0.29*sqrt(pt);
  if(flav==kB){ 
 ...
 double res::HelperJet::b(double pt, double eta,  Flavor flav)
{
  double res = 0.29*sqrt(pt);
  if(flav==kB){ 
 ...
 double res::HelperJet::c(double pt, double eta,  Flavor flav)
{
  double res = 0.29*sqrt(pt);
  if(flav==kB){ 
 ...
 double res::HelperJet::d(double pt, double eta,  Flavor flav)
{
  double res = 0.29*sqrt(pt);
  if(flav==kB){ 
 ...
 double res::HelperJet::theta(double pt, double eta,  Flavor flav)
{
  double res = 0.29*sqrt(pt);
  if(flav==kB){ 
 ...
 double res::HelperJet::phi(double pt, double eta,  Flavor flav)
{
  double res = 0.29*sqrt(pt);
  if(flav==kB){ 
...
double res::HelperJet::et(double pt, double eta,  Flavor flav)
{
  double res = 0.29*sqrt(pt);
  if(flav==kB){ 
 ...
 double res::HelperJet::eta(double pt, double eta,  Flavor flav)
{
