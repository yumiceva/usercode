...
{ 
  ...
  // This is parametrized by a simple normalized gaussian distribution. 
  //---------------------------------------------------------------------------  
	Double_t sig = sqrt( parms[Par_Sigbeam]*parms[Par_Sigbeam] + 2.5*2.5*sigmad*sigmad  );
...
int main(int argc, char **argv)
{
 ...
 tnt *t = new tnt(in_filename);
 
  
 //r/TH1F *h_z = (TH1F*) gDirectory->Get("z0");
 //r/h_z->SetDirectory(0);
 ...
 //r/h_z->Fit("gaus");
 //r/TF1 *mygaus = h_z->GetFunction("gaus");
